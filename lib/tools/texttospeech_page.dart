...
class _TextToSpeechPage extends State<TextToSpeechPage> {
      ...
      setState(() {
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            content: Text(t.tools.texttospeech.error.please_try_again),
          ));
          setState(() {
            isPlaying = false;
          });
  ...
  Future<void> initCurrentLanguageFromSharedPreferences() async {
    var prefs = await SharedPreferences.getInstance();
    var tempCurrentLanguage =
        prefs.getString(SHARED_PREFERENCES_TOOL_TEXTTOSPEECH_LANGUAGE);
