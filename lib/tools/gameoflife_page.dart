...
class _GameOfLifePage extends State<GameOfLifePage> {
  ...
  void updateGrid() {
    List<List<bool>> newGrid =
        List.generate(_gridSize, (i) => List<bool>.filled(_gridSize, false));
  ...
  void startOrStopSimulation() {
    if (!stillAliveCells() && mounted) {
      showOkTextDialog(context, t.tools.gameoflife.error.no_alive_cells,
        ...
        return StatefulBuilder(
          builder: (context, _setState) => AlertDialog(
            ...
            content: Column(
              ...
              children: [
                Text(t.tools.gameoflife
                    .current_size_is_x(size: _gridSize.toString())),
  ...
  Widget build(BuildContext context) {
    double scale =
        MediaQuery.of(context).orientation == Orientation.portrait ? 1 : 0.4;

    Color emptyGridBackgroundColor =
