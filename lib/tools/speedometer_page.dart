...
class _SpeedometerPage extends State<SpeedometerPage> {
  ...
  Future<void> initSharedPreferences() async {
    ...
    _isUsingMpH =
        prefs.getBool(SHARED_PREFERENCES_TOOL_SPEEDOMETER_ISUSINGMPH) ?? false;
  }
                  ...
                  if (mounted) {
                    showDialog(
                      ...
                      builder: (BuildContext context) {
                        return AlertDialog(
                          title: Text(
                            t.tools.speedometer.change_speed_unit,
                                  ...
                                  children: [
                                    FilledButton(
                                        onPressed: () {
                                          Navigator.of(context).pop();
                                          prefs.setBool(
                                              SHARED_PREFERENCES_TOOL_SPEEDOMETER_ISUSINGMPH,
                                              false);
                                          setState(() {
                                            _isUsingMpH = false;
                                          });
