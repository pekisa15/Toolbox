...
class _QrReaderPage extends State<QrReaderPage> {
  ...
  void onScanned(Code capture, {bool showErrorIfNoResult = false}) {
    ...
    if (value.startsWith("http://") || value.startsWith("https://")) {
      ...
      showCustomButtonsTextDialog(
          context, t.tools.qrreader.scanned, value, buttons,
  ...
  Future<void> searchQrOnImage() async {
    ...
    if (image != null) {
      Code resultFromPath = await zx.readBarcodeImagePath(image,
          DecodeParams(imageFormat: ImageFormat.rgb, format: Format.qrCode));
